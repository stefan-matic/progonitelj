...
| Branch | Ecosystem | Pipeline | Violations |
| --- | --- | --- | --- |
| [`example/docker-violation`](https://github.com/stefan-matic/progonitelj/tree/example/docker-violation) | Docker | [![](https://github.com/stefan-matic/progonitelj/actions/workflows/example-check.yml/badge.svg?branch=example/docker-violation)](https://github.com/stefan-matic/progonitelj/actions/workflows/example-check.yml?query=branch%3Aexample%2Fdocker-violation) | `ubuntu` (blocked), `centos` (blocked), `nginx:latest` (unpinned), `python:3.10` (not in pinned list) |
| [`example/python-violation`](https://github.com/stefan-matic/progonitelj/tree/example/python-violation) | Python | [![](https://github.com/stefan-matic/progonitelj/actions/workflows/example-check.yml/badge.svg?branch=example/python-violation)](https://github.com/stefan-matic/progonitelj/actions/workflows/example-check.yml?query=branch%3Aexample%2Fpython-violation) | `flask` 2.0, `requests` 2.20, `cryptography` 40.0, `urllib3` 1.26, `pydantic` 1.10 (all below min), `some-shady-package` (unlisted) |
| [`example/php-violation`](https://github.com/stefan-matic/progonitelj/tree/example/php-violation) | PHP | [![](https://github.com/stefan-matic/progonitelj/actions/workflows/example-check.yml/badge.svg?branch=example/php-violation)](https://github.com/stefan-matic/progonitelj/actions/workflows/example-check.yml?query=branch%3Aexample%2Fphp-violation) | `laravel` ^9.0, `guzzle` ^6.5, `monolog` ^2.0, `phpunit` ^9.0 (all below min), `some-unknown/vendor-package` (unlisted) |
| [`example/npm-violation`](https://github.com/stefan-matic/progonitelj/tree/example/npm-violation) | npm | [![](https://github.com/stefan-matic/progonitelj/actions/workflows/example-check.yml/badge.svg?branch=example/npm-violation)](https://github.com/stefan-matic/progonitelj/actions/workflows/example-check.yml?query=branch%3Aexample%2Fnpm-violation) | `react` 17, `next` 13, `axios` 0.21, `lodash` 4.17.15, `typescript` 4.9 (all below min), `left-pad` & `event-stream` (unlisted) |
| [`example/go-violation`](https://github.com/stefan-matic/progonitelj/tree/example/go-violation) | Go | [![](https://github.com/stefan-matic/progonitelj/actions/workflows/example-check.yml/badge.svg?branch=example/go-violation)](https://github.com/stefan-matic/progonitelj/actions/workflows/example-check.yml?query=branch%3Aexample%2Fgo-violation) | `gin` 1.7, `gorm` 1.20, `zap` 1.20, `jwt` 5.0 (CVE), `x/crypto` 0.10 (all below min), `some-unknown/module` (unlisted) |
