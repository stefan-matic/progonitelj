...
**Progonitelj** (Serbian for "the banisher" / "the one who drives away") is a zero-cost, open-source tool that controls what packages, container images, and tool versions are allowed in your development and CI/CD pipelines.
...
```bash
# Clone and install
git clone https://github.com/your-org/progonitelj.git
cd progonitelj
pip install -e ".[dev]"
